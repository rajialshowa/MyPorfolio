    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("b5f90e92-c2ea-49f7-981e-fb8c511014dd"), "This text to be filled in section 1", "This text to be filled in section 2" });

            migrationBuilder.InsertData(
                table: "Owner",
                columns: new[] { "Id", "AddressId", "Avatar", "FullName", "Profil" },
                values: new object[] { new Guid("52b47d89-a25b-4e6b-837c-7ccd54fc8fb5"), null, "Avarat.jpg", "Raji Alshawa A", "MCSD.NET Professional" });
